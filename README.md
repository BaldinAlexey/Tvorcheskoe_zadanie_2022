...
##### Примечание: 
> Файл .exe – хоть и является собранным решением, но без установки данных файлов, может и не запуститься.
> Поэтому, чтобы корректно запустить приложение, нужно перекинуть .dll - файлы (находятся в архиве по ссылке) в папку C:\Windows\SysWOW64
